...
class _$AppStateImpl implements _AppState {
  ...
  @override
  String toString() {
    return 'AppState(accessToken: $accessToken, refreshToken: $refreshToken, userId: $userId, userRole: $userRole, isLoggedIn: $isLoggedIn, isAppStarted: $isAppStarted)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, accessToken, refreshToken,
      userId, userRole, isLoggedIn, isAppStarted);
