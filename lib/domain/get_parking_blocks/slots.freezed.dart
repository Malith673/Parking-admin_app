...
class _$SlotsImpl implements _Slots {
  ...
  @override
  String toString() {
    return 'Slots(id: $id, slotNumber: $slotNumber, isOccupied: $isOccupied, blockId: $blockId, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _Slots implements Slots {
  factory _Slots(
      ...
      required final String updatedAt}) = _$SlotsImpl;
