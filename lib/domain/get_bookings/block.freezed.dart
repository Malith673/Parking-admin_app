...
class _$BlockImpl implements _Block {
  ...
  @override
  String toString() {
    return 'Block(id: $id, blockName: $blockName, locationId: $locationId, availableSlots: $availableSlots, totalSlots: $totalSlots)';
  }
...
abstract class _Block implements Block {
  factory _Block(
      ...
      required final int totalSlots}) = _$BlockImpl;
