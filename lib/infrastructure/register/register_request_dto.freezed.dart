...
class _$RegisterRequestDtoImpl extends _RegisterRequestDto {
  ...
  @override
  String toString() {
    return 'RegisterRequestDto(name: $name, email: $email, password: $password, role: $role)';
  }
...
abstract class _RegisterRequestDto extends RegisterRequestDto {
  factory _RegisterRequestDto(
      ...
      required final String role}) = _$RegisterRequestDtoImpl;
  _RegisterRequestDto._() : super._();
