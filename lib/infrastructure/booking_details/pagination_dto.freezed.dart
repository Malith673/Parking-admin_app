...
class _$PaginationDtoImpl extends _PaginationDto {
  ...
  @override
  String toString() {
    return 'PaginationDto(currentPage: $currentPage, totalPages: $totalPages, totalItems: $totalItems, itemsPerPage: $itemsPerPage)';
  }
...
abstract class _PaginationDto extends PaginationDto {
  factory _PaginationDto(
      ...
      required final int itemsPerPage}) = _$PaginationDtoImpl;
  _PaginationDto._() : super._();
