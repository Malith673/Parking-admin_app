...
abstract class $LoginResponseDtoCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool success, int statusCode, UserDto user, String token});
...
class _$LoginResponseDtoImpl extends _LoginResponseDto {
  ...
  @override
  String toString() {
    return 'LoginResponseDto(success: $success, statusCode: $statusCode, user: $user, token: $token)';
  }
...
abstract class _LoginResponseDto extends LoginResponseDto {
  factory _LoginResponseDto(
      ...
      required final String token}) = _$LoginResponseDtoImpl;
  _LoginResponseDto._() : super._();
