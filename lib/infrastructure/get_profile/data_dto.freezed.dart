...
mixin _$DataDto {
  ...
  List<VehiclesDto> get vehicles => throw _privateConstructorUsedError;
...
class _$DataDtoImpl extends _DataDto {
  _$DataDtoImpl(
      ...
      required final List<VehiclesDto> vehicles})
      : _vehicles = vehicles,
        super._();
  ...
  final List<VehiclesDto> _vehicles;
  @override
  List<VehiclesDto> get vehicles {
  ...
  @override
  String toString() {
    return 'DataDto(id: $id, name: $name, email: $email, role: $role, createdAt: $createdAt, updatedAt: $updatedAt, vehicles: $vehicles)';
  }
...
abstract class _DataDto extends DataDto {
  factory _DataDto(
      ...
      required final List<VehiclesDto> vehicles}) = _$DataDtoImpl;
  _DataDto._() : super._();
